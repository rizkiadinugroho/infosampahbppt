        ...
        <nav class="navbar navbar-default navbar-fixed-top">
          <div class="container">
            <div class="navbar-header">
              ...
              <a class="navbar-brand" href="#">#INFO<span class="logo-dec">SAMPAH</span></a>
            </div>
            <div class="collapse navbar-collapse" id="myNavbar">
              <ul class="nav navbar-nav navbar-right">
                <li class="active"><a href="#main-header">Beranda</a></li>
                <li class=""><a href="#feature">Tentang</a></li>
                <li class=""><a href="#service">Layanan Teknologi</a></li>
                <li class=""><a href="#portfolio">Inovasi Teknologi</a></li>
                <li class=""><a href="#testimonial">Unit</a></li>
                <li class=""><a href="#blog">Berita</a></li>
                <li class=""><a href="#contact">Kontak Kami</a></li>
              </ul>
            </div>
          </div>
        </nav>
        ...
        <div class="row">
          ...
          <div class="col-md-4 col-sm-6 col-xs-12 portfolio-item padding-right-zero mr-btn-15">
            <figure>
              ...
              <figcaption>
                  <h2><a href=#>Project For Everyone</a></h2>
